...
do
  ...
  mv dictd.pp dictd.pp.${selinuxvariant}
...
do
  ...
  install -p -m 644 SELinux/dictd.pp.${selinuxvariant} \
    %{buildroot}%{_datadir}/selinux/${selinuxvariant}/dictd.pp
done
